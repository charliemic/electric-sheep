...
check_scope_creep() {
    ...
    echo "5. Would a new agent help maintain focus and clarity?"
    ...
    echo "- MODERATE_SCOPE_CREEP: Significant expansion, consider new agent"
    echo "- SEVERE_SCOPE_CREEP: Major expansion, strongly recommend new agent"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    ...
    echo ""
    echo "To start a new agent:"
    echo "  1. Commit current work: git commit -m 'WIP: [description]'"
    echo "  2. Start new Cursor chat session (Cmd+L)"
